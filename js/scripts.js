...
(function ($) {
    ...
    jQuery(document).ready(function () {
       ...
       /* Preloader */
        ...
        /* Modal for on-click of Portfolio panels */
       ...
       /* Mobile Navigation Hide or Collapse on Click */
        ...
        $(".typing").typed({
            strings: ["Machine Learning", "Deep Learning", "Full Stack", "DevOps", "Python", "Software Developer"],    /* You can change the home section typing text from here and do not use "&" use "and" */
            typeSpeed: 40
          });
         });
        ...
        $('.statistics').appear(function() {
         ...
         $('#my-address').gMap({
            ...
            markers:[
            {
            address: "1209 Boylston Street",  /* You can change your address from here */
            html: "<b>Address</b>: <br> Boston MA - 02215",   /* You can change display address text from here */
            popup: true
            }
            ]
            });
